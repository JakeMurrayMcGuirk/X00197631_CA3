...
Added the NVD API Keys as environment variables in my Azure DevOps Pipeline settings as opposed to hardcoding them into my azure-pipeliens.yml file as it reduced change of leaking the API Keys.

## Deployment Process
**Environments**:\
Test: UAT and Performance Testing
Production: Live deployment
**Stages: ** Build -> Security Scan -> Dependency Scan -> Deploy to Test Env -> Run UAT'ing -> Run Performance Testing -> Approval Gate (manual) -> Deploy to Production Env\
Artifacts published after building, results published after testing, artifacts downloaded for deploying\
NVD API Keys stored as variables as stated previously.
